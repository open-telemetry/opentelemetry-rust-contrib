...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    let exporter =
        opentelemetry_etw_metrics::MetricsExporter::new("metric-demo", None, None).unwrap();
    ...
    loop {
        ...
        println!("Added 10 to updown_counter");
        ...
        println!("Added 10.0 to updown_counter2");
        ...
        println!("Recorded 10.5 to histogram");
        ...
        println!("Recorded 10 to histogram2");
