...
mod tests {
    ...
    #[test]
    fn register() {
        let _provider = ProviderGuard::register("provider_name", None, None).unwrap();
    ...
    fn duplicate_provider_name_registration_fails() {
        let _provider = ProviderGuard::register("duplicate_provider_name", None, None).unwrap();

        let result = ProviderGuard::register("duplicate_provider_name", None, None);
    ...
    fn multiple_unregister_calls_succeed() {
        let provider = ProviderGuard::register("multiple_unregister_calls", None, None).unwrap();
