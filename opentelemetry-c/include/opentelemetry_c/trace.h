 ...
 *
 * Returns NULL on invalid arguments. Release with otel_tracer_destroy().
 */
 ...
 *
 * Returns NULL on invalid arguments. The returned span must be ended with
 * otel_span_end() and released with otel_span_destroy(). Destroying a span that was
 * not explicitly ended performs a best-effort end first.
 */
