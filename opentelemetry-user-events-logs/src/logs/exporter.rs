...
impl<'a> ExportOptions<'a> {
    ...
    /// Builder for `EventsOptions`, with a mandatory provider_name.
    /// This is the name of the provider that will be used to register the event sets.
    ...
    pub fn builder(provider_name: &'a str) -> ExportOptionsBuilder<'a> {
...
#[derive(Debug)]
pub struct ExportOptionsBuilder<'a> {
    provider_name: &'a str,
}
...
impl<'a> ExportOptionsBuilder<'a> {
    ...
    /// Builds the `ExportOptions` or returns an error if validation fails.
    pub fn build(self) -> Result<ExportOptions<'a>, String> {
